...
- Identifies services by known IP ranges (GitHub, Cloudflare, AWS, Google Cloud, Vercel, Fly.io, Linear, etc.) and reverse DNS
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  ───────────────────────────────────────  ────────  ────────  ────────  ──────────────────────────────────────
  2607:6bc0::10                              1.6 MB    8.1 MB    9.7 MB  Conductor (Linear)
  160.79.104.10                            714.2 KB  734.8 KB    1.4 MB  Conductor (Linear)
  140.82.116.6                             375.9 KB   55.8 KB  431.6 KB  GitHub
  2606:4700::6810:122                      363.1 KB   16.8 KB  379.9 KB  Cloudflare
  2600:1901:0:3084::                        12.9 KB  122.5 KB  135.4 KB  Google Cloud
  140.82.116.4                              92.3 KB   15.1 KB  107.5 KB  GitHub
  2606:4700:10::ac42:9478                   59.2 KB   21.0 KB   80.1 KB  Cloudflare
  2606:4700:10::6814:11a7                   44.4 KB    3.0 KB   47.4 KB  Cloudflare
  2600:1f18:4c12:9a02:c6c7:fc08:82f6:ce27   12.8 KB   24.4 KB   37.2 KB  AWS
  172.66.148.120                            20.1 KB    3.8 KB   23.9 KB  Cloudflare
  76.76.21.22                               18.7 KB    2.4 KB   21.1 KB  Vercel
  2606:4700:10::6814:1bcc                   10.8 KB    8.8 KB   19.6 KB  Cloudflare
  2a09:8280:1::c6:3c04:0                     8.0 KB    6.9 KB   15.0 KB  Fly.io
  66.33.60.35                                9.4 KB    1.2 KB   10.5 KB  Linear/Render
  34.149.66.137                              4.9 KB    3.4 KB    8.2 KB  137.66.149.34.bc.googleusercontent.com
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  Service                                 Flows     Bytes      %
  ──────────────────────────────────────  ─────  ────────  ─────
  Conductor (Linear)                      1,636   11.1 MB  89.5%
  Cloudflare                                 66  570.7 KB   4.5%
  GitHub                                     38  539.1 KB   4.2%
  Google Cloud                                6  135.4 KB   1.1%
  AWS                                         2   37.2 KB   0.3%
  Vercel                                      4   21.1 KB   0.2%
  Fly.io                                      4   15.0 KB   0.1%
  Linear/Render                               2   10.5 KB   0.1%
  137.66.149.34.bc.googleusercontent.com      6    8.2 KB   0.1%
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  ───────────────────────────  ─  ───────────────────────────────────────────  ─────  ─────  ────────  ───────  ──────────────────
  ::0.1.31.140:2960            →  2607:6bc0::10:443                            TCP    1,056    3.4 MB  FIN,SYN  Conductor (Linear)
  ::0.1.31.140:2958            →  2607:6bc0::10:443                            TCP      687    2.5 MB  FIN,SYN  Conductor (Linear)
  ::0.1.31.140:2956            →  2607:6bc0::10:443                            TCP      165  662.3 KB  FIN,SYN  Conductor (Linear)
  ::0.1.31.140:3167            →  2607:6bc0::10:443                            TCP      104  440.1 KB  FIN,SYN  Conductor (Linear)
  2607:6bc0::10:443            →  ::0.1.31.140:2960                            TCP    1,054  223.5 KB  FIN,SYN  Local
  ::0.1.36.38:3416             →  2607:6bc0::10:443                            TCP       35  199.8 KB  FIN,SYN  Conductor (Linear)
  ...
  ::0.1.31.140:3222            →  2600:1901:0:3084:::443                       TCP       25  119.0 KB  FIN,SYN  Google Cloud
  ::0.1.31.140:2999            →  2607:6bc0::10:443                            TCP       49   91.8 KB  FIN,SYN  Conductor (Linear)
  ::0.1.31.140:2954            →  2607:6bc0::10:443                            TCP       22   87.5 KB  FIN,SYN  Conductor (Linear)
  0.1.36.38:3539               →  160.79.104.10:443                            TCP       15   82.0 KB  FIN,SYN  Conductor (Linear)
  0.1.36.38:3789               →  160.79.104.10:443                            TCP       16   69.2 KB  FIN,SYN  Conductor (Linear)
  0.1.36.38:3419               →  160.79.104.10:443                            TCP       15   65.2 KB  FIN,SYN  Conductor (Linear)
  ...
  0.1.36.38:3773               →  160.79.104.10:443                            TCP       15   26.7 KB  FIN,SYN  Conductor (Linear)
  ::0.1.29.94:2723             →  2600:1f18:4c12:9a02:c6c7:fc08:82f6:ce27:443  TCP       45   24.4 KB  SYN      AWS
...
The trace was captured while working on [this diff](https://github.com/ArcadeAI/docs/compare/evantahler/landing-ascii-logo?expand=1) in the ArcadeAI docs repo — primarily Conductor (Linear) project management traffic with GitHub and Cloudflare-fronted services in the background.
